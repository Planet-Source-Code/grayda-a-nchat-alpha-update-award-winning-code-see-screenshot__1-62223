...
' This module lets us encrypt strings using SHA-Encryption. This module was taken
' from (Sorry, I don't know the name. Please forgive me!!), but their web-site is:

' www.dep.zion.me.uk/

' Please visit their site. Their MSN Messiah Open Source is really good!
' If you are the author of this code, please e-mail me at firestorm_visual@hotmail.com
' And I'll Add you to the about box, so you get some credit...
